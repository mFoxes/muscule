...
{
    public class EquipmentHallRepository : GenericRepository<EquipmentHall>, IEquipmentHallRepository
    {
        public EquipmentHallRepository(EquipmentDbContext context)
            : base(context)
        {
